...
def makeReport(folder: str):
    report = SimpleDocTemplate(f"{folder}/final/report.pdf", pagesize = A4) # Make A4 page
    ...
    docElements.append(Image(f"{folder}/process/1.png", width=10*cm, height=10*cm))
    note = notes.readline()
    ...
    docElements.append(Image(f"{folder}/process/2.png", width=10*cm, height=10*cm))
    docElements.append(Paragraph("Gathered Materials", styles["Heading3"]))
    note = notes.readline()
    splitNote = note.replace('\t',"<br/><br/>")
    ...
    docElements.append(Image(f"{folder}/process/5.png", width=10*cm, height=10*cm))
    note = notes.readline()
    docElements.append(Paragraph(f"{note}", styles["Normal"]))
    docElements.append(Spacer(1, 3 * cm))
